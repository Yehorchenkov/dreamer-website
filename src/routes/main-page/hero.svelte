...
<section class="flex items-center justify-center">
    <div class="flex flex-col md:flex-row items-center gap-x-6 w-full m-2 md:m-10 bg-radial-[at_25%_25%] from-yellow-700 to-yellow-400 border border-gray-300 rounded-lg shadow-lg">
        ...
        <!-- Right side: image -->
        <div class="md:w-1/2 flex items-center justify-center relative overflow-visible">
            <enhanced:img 
                src="$lib/images/hero-image.png" 
                alt="construction site" 
                class="z-20 h-64 w-auto md:h-full object-cover rounded-lg"
            />
        </div>
    </div>
</section>
